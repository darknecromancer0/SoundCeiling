...
if grep -Fq 'static final boolean RUNTIME_QUARANTINED = true;' "$R/app/src/main/java/dev/soundceiling/app/EnhancedSessionSetup.java"; then
  need "$R/app/src/main/java/dev/soundceiling/app/AndroidDynamicsProcessingTransport.java" 'false, true);'
