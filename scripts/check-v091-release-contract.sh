...
need "$GRADLE" 'versionCode=42'
need "$GRADLE" 'versionName="0.11.2"'
...
need "$WORKFLOW" 'name: SoundCeiling-v0.11.2-source-snapshot'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.2-debug-apk'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.2-debug-apk-checksum'
...
need "$README" '# Sound Ceiling for Android - v0.11.2'
