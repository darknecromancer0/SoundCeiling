...
need "$GRADLE" 'versionCode=40'
need "$GRADLE" 'versionName="0.11.0"'
...
need "$WORKFLOW" 'name: SoundCeiling-v0.11.0-source-snapshot'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.0-debug-apk'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.0-debug-apk-checksum'
...
need "$README" '# Sound Ceiling for Android - v0.11.0'
