...
need "$GRADLE" 'versionCode=41'
need "$GRADLE" 'versionName="0.11.1"'
...
need "$WORKFLOW" 'name: SoundCeiling-v0.11.1-source-snapshot'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.1-debug-apk'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.1-debug-apk-checksum'
...
need "$README" '# Sound Ceiling for Android - v0.11.1'
