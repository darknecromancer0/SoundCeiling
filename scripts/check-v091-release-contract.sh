...
need "$GRADLE" 'versionCode=45'
need "$GRADLE" 'versionName="0.11.5"'
...
need "$WORKFLOW" 'name: SoundCeiling-v0.11.5-source-snapshot'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.5-debug-apk'
need "$WORKFLOW" 'name: SoundCeiling-v0.11.5-debug-apk-checksum'
...
need "$README" '# Sound Ceiling for Android - v0.11.5'
