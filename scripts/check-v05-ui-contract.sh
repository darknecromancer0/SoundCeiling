...
require "$PKG/StatusText.java" "Mixed apps - raise paused"
require "$PKG/StatusText.java" "Source uncertain - raise paused"
...
require "$PKG/AdvancedModeView.java" "Source confidence"
require "$PKG/AdvancedModeView.java" "Metering capability"
require "$PKG/AdvancedModeView.java" "Volume control capability"
require "$PKG/AdvancedModeView.java" "DSP capability"
