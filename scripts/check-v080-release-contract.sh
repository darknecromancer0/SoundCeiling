...
need "$R/app/build.gradle.kts" 'versionCode=35'
need "$R/app/build.gradle.kts" 'versionName="0.8.0"'
...
need "$R/.github/workflows/build-apk.yml" 'name: SoundCeiling-v0.8.0-debug-apk'
...
echo 'v0.8 release contract: PASS'
